...
let webring = {
	...
	loadWebringJsons: function(callbackWhenAllHaveLoaded) {
		...
		getWebringList("https://planches.4feuilles.org/webring.json");      // URL of your webring.json
		getWebringList("https://planches.4feuilles.org/compiled_webring.json");     // URL of your compiled_webring.json
	},
	...
	init: function() {
		// create webring open buttons      ---- NAME OF THE CLASS FOR THE BUTTON
